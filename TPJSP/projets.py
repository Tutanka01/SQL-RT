...
cur = con.cursor()
res = [x for x in cur.execute("SELECT nometud, COUNT(*) FROM etudiant, projet WHERE etudiant.idetud = projet.idetud GROUP BY nometud HAVING COUNT(*) > 0")]
print(res[0][1])
